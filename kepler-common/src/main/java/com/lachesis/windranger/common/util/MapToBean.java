...
/**
 * Created by changsheng.wang on 2017/9/4.
 */
public class MapToBean {
     ...
     */
    public static Object mapToObject_COMMON(Map<String, Object> map, Class<?> beanClass) throws Exception {
        if (map == null)
            return null;
    ...
    public static Map<?, ?> objectToMap_COMMON(Object obj) {
        if (obj == null)
            return null;
